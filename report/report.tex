...
\begin{document}
  ...
  the respective convolution integrals may be evaluated more computationally efficient using the \gls{fft} and \glstext{ifft} (for more information on this relationship, we refer the reader to \cite{2022-convolution-theorem}).
